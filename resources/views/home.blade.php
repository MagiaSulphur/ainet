<x-layouts::main-content title="Department of Computer Engineering" heading="Introduction">
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="my-4 p-6 bg-zinc-50   border border-zinc-200 overflow-hidden shadow-sm sm:rounded-lg text-gray-900">
            <h3 class="pb-3 font-semibold text-lg text-gray-800 leading-5">
                Department of Computer Engineering
            </h3>
            <p class="py-3 text-sm font-light leading-7 text-gray-700">
        ...
        <div class="my-8 p-6 bg-zinc-50   border border-zinc-200 overflow-hidden shadow-sm sm:rounded-lg text-gray-900">
            <h3 class="pb-3 font-semibold text-lg text-gray-800 leading-5">
                Organization
            </h3>
            <p class="py-3 text-sm font-light leading-7 text-gray-700">
            ...
            <ul class="list-disc ms-12">
                <li class="py-1 text-sm font-light leading-7 text-gray-700">Coordinator;</li>
                <li class="py-1 text-sm font-light leading-7 text-gray-700">Department Council;</li>
                <li class="py-1 text-sm font-light leading-7 text-gray-700">Plenary.</li>
            </ul>
            </p>
        </div>
    </div>
